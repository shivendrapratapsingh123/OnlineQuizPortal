    ...
    >
      <Form
        ...
        initialValues={{
          ...
          A: selectedQuestion?.options ? JSON.parse(selectedQuestion.options).A : '',
          B: selectedQuestion?.options ? JSON.parse(selectedQuestion.options).B : '',
          C: selectedQuestion?.options ? JSON.parse(selectedQuestion.options).C : '',
          D: selectedQuestion?.options ? JSON.parse(selectedQuestion.options).D : '',
